...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		setTitle("Menu Principal - Hotel-Alura");
...
//		setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
		...
		JLabel lblNewLabel_3 = new JLabel("Desarrollado por Leonardo Tolaba - 2022");
		...
		btnSalir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Object [] opciones ={"Si","Cancelar"};
				 int eleccion = JOptionPane.showOptionDialog(rootPane,"¿Realmente desea salir de la aplicacion?","Mensaje de Confirmacion",
